                                                ...
                                                <ul class="list-unstyled fruite-categorie">
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a
                                                                href="http://localhost:8080/products?page=1&sort=gia-nothing&factory=APPLE"><i
                                                    ...
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a
                                                                href="http://localhost:8080/products?page=1&sort=gia-nothing&factory=DELL"><i
                                                    ...
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a
                                                                href="http://localhost:8080/products?page=1&sort=gia-nothing&factory=ASUS"><i
                                                    ...
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a
                                                                href="http://localhost:8080/products?page=1&sort=gia-nothing&factory=ACER"><i
                                                    ...
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a
                                                                href="http://localhost:8080/products?page=1&sort=gia-nothing&factory=LENOVO"><i
